Some browser has canvas but not toDataURL support.

This script aim is to be able to create a canvas snapshot in about 450 bytes gzipped and for a Bitmap 32 bit with alpha channel.

Please read *code* comments to know more.

[demo](https://web.archive.org/web/20161107105420/http://www.3site.eu/bmp.html)
